...
public interface Spawner {
	...
	public static class SecondBossSpawner implements Spawner {
		...
		@Override
		public BadGuy getBadGuy() {
			return new ShootingBadGuy(64, 1f, "SecondBoss.png", "Boss2", true, 1, 1, 1, "BasicBadProjectile.png") {
	...
	public static class ShootingSpawner implements Spawner {
		...
		@Override
		public BadGuy getBadGuy() {
			return new ShootingBadGuy(8, 2, "ShootingBadGuy.png", "Shooting", false, 1, 1, 1, "BasicBadProjectile.png") {
